...
from common.notify_config import NotifyEmail
from common.notify.base import RenderedNotification
...
class EmailChannel:
    ...
    def send(self, notification: RenderedNotification) -> bool:
        try:
            _send_smtp(self._cfg, notification.subject, notification.bodies["email"])
            return True
